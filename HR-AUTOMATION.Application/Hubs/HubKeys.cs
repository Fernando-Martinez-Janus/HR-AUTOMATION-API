namespace HR_AUTOMATION.Application.Hubs
{
    public static class HubKeys
    {
        public const string SkillCategoryChanged = "skillCategoryChanged";
        public const string SkillChanged = "skillChanged";
        public const string SkillLevelChanged = "skillLevelChanged";
        public const string AreaLevelChanged = "areaLevelChanged";
        public const string CriticalityLevelChanged = "criticalityLevelChanged";
        ...
        public const string SearchResultsChanged = "searchResults";
    }
}