...
{
    /// <summary>
    /// Provides business logic for managing seniority levels.
    /// </summary>
    ...
    public class SeniorityLevelService(
        ILogger<SeniorityLevelService> logger,
        ISharedRepository sharedRepository,
        ICacheService cacheService,
        IConfiguration configuration,
        IHttpContextService httpContextService,
        IHubContext<NotificationHub> notificationHub
    ) : ISeniorityLevelService
    {
        /// <summary>
        /// Used for logging error and information messages.
        /// </summary>
        private readonly ILogger<SeniorityLevelService> _logger = logger;
        ...
        /// <summary>
        /// Defines the default expiration time used for cached seniority level data.
        /// </summary>
        ...
        /// <summary>
        /// Defines the long expiration time used for cached seniority level data.
        /// </summary>
        ...
        /// </summary>
        private void ValidateModel(SeniorityLevelInputModel model)
        {
            ...
            ValidationResult validationResult = new SeniorityLevelValidator().Validate(model);
        ...
        /// <summary>
        /// Updates the cache version and notifies the appropriate SignalR groups that seniority levels have changed.
        /// </summary>
        ...
        private async Task HandleChangedAsync(int? organizationId = null, int? id = null)
        {
            if (id.HasValue)
            {
                string idKey = SeniorityLevelCacheKeys.ById(id.Value);
            ...
            if (organizationId.HasValue)
            {
                ...
                await _cacheService.SetAsync(SeniorityLevelCacheKeys.Version(organizationId.Value), CacheKeyHelper.GenerateVersion());
            }

            await _cacheService.SetAsync(SeniorityLevelCacheKeys.Version(), CacheKeyHelper.GenerateVersion());
            await _notificationHub.Clients.Groups(notifyTo).SendAsync(HubKeys.SeniorityLevelChanged);
        }
        ...
        public async Task<IEnumerable<SeniorityLevelViewModel>> SearchAsync(SeniorityLevelSearchInputModel model)
        {
            try
            {
                int? organizationId = _httpContextService.GetOrganizationId();
                ...
                string versionKey = SeniorityLevelCacheKeys.Version(model.OrganizationId);
                ...
                string searchKey = SeniorityLevelCacheKeys.Search(model, version);
                IEnumerable<SeniorityLevelViewModel>? cacheResult = await _cacheService.GetAsync<IEnumerable<SeniorityLevelViewModel>>(searchKey);
                ...
                IEnumerable<SeniorityLevelModel> result = await _sharedRepository.QueryAsync<SeniorityLevelModel>("[config].[web_get_seniority_levels]", parameters);

                IEnumerable<SeniorityLevelViewModel> mappedResult = Mapping.Mapper.Map<IEnumerable<SeniorityLevelViewModel>>(result);
        ...
        public async Task<SeniorityLevelViewModel> GetAsync(int id)
        {
            try
            {
                string idKey = SeniorityLevelCacheKeys.ById(id);

                SeniorityLevelViewModel? cacheResult = await _cacheService.GetAsync<SeniorityLevelViewModel>(idKey);
                ...
                SeniorityLevelModel result =
                    await _sharedRepository.QuerySingleAsync<SeniorityLevelModel>("[config].[web_get_seniority_level_by_id]", parameters)
                    ?? throw new ResponseExceptionFactory(Exceptions.SeniorityLevelNotFound);

                SeniorityLevelViewModel mappedResult = Mapping.Mapper.Map<SeniorityLevelViewModel>(result);
        ...
        public async Task<int> CreateAsync(SeniorityLevelInputModel model)
        {
            try
            {
                ValidateModel(model);
                ...
                List<KeyValuePair<string, object?>> parameters = [
                    new("@p_organization_id", model.OrganizationId),
                    new("@p_name", model.SeniorityName),
                    new("@p_created_by", _httpContextService.GetUserId()),
                ];

                SeniorityLevelModel result =
                   await _sharedRepository.QuerySingleAsync<SeniorityLevelModel>("[config].[web_insert_seniority_level]", parameters)
        ...
        public async Task UpdateAsync(int id, SeniorityLevelInputModel model)
        {
            try
            {
                ValidateModel(model);
                ...
                await _sharedRepository.ExecuteAsync("[config].[web_update_seniority_level]", parameters);
        ...
        public async Task DeleteAsync(int id)
        {
            try
            {
                ...
                SeniorityLevelModel result =
                   await _sharedRepository.QuerySingleAsync<SeniorityLevelModel>("[config].[web_delete_seniority_level]", parameters)
                    ?? throw new ResponseExceptionFactory(Exceptions.InternalServerError);
        ...
        public async Task ReorderAsync(ReorderInputModel model)
        {
            try
            {
                ...
                await _sharedRepository.ExecuteAsync("[config].[web_reorder_seniority_levels]", parameters);
