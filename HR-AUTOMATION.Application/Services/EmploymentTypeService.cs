...
{
    /// <summary>
    /// Provides business logic for managing employment types.
    /// </summary>
    ...
    public class EmploymentTypeService(
        ILogger<EmploymentTypeService> logger,
    ...
    ) : IEmploymentTypeService
    {
        ...
        /// </summary>
        private readonly ILogger<EmploymentTypeService> _logger = logger;
        ...
        /// <summary>
        /// Defines the default expiration time used for cached employment type data.
        /// </summary>
        ...
        /// <summary>
        /// Defines the long expiration time used for cached employment type data.
        /// </summary>
        ...
        /// </summary>
        private void ValidateModel(EmploymentTypeInputModel model)
        {
            ...
            ValidationResult validationResult = new EmploymentTypeValidator().Validate(model);
        ...
        /// <summary>
        /// Updates the cache version and notifies the appropriate SignalR groups that employment types have changed.
        /// </summary>
        ...
        private async Task HandleChangedAsync(int? organizationId = null, int? id = null)
        {
            if (id.HasValue)
            {
                string idKey = EmploymentTypeCacheKeys.ById(id.Value);
            ...
            if (organizationId.HasValue)
            {
                ...
                await _cacheService.SetAsync(EmploymentTypeCacheKeys.Version(organizationId.Value), CacheKeyHelper.GenerateVersion());
            }

            await _cacheService.SetAsync(EmploymentTypeCacheKeys.Version(), CacheKeyHelper.GenerateVersion());
            await _notificationHub.Clients.Groups(notifyTo).SendAsync(HubKeys.EmploymentTypeChanged);
        }
        ...
        public async Task<IEnumerable<EmploymentTypeViewModel>> SearchAsync(EmploymentTypeSearchInputModel model)
        {
            try
            {
                int? organizationId = _httpContextService.GetOrganizationId();
                ...
                string versionKey = EmploymentTypeCacheKeys.Version(model.OrganizationId);
                ...
                string searchKey = EmploymentTypeCacheKeys.Search(model, version);
                IEnumerable<EmploymentTypeViewModel>? cacheResult = await _cacheService.GetAsync<IEnumerable<EmploymentTypeViewModel>>(searchKey);
                ...
                IEnumerable<EmploymentTypeModel> result = await _sharedRepository.QueryAsync<EmploymentTypeModel>("[config].[web_get_employment_types]", parameters);

                IEnumerable<EmploymentTypeViewModel> mappedResult = Mapping.Mapper.Map<IEnumerable<EmploymentTypeViewModel>>(result);
        ...
        public async Task<EmploymentTypeViewModel> GetAsync(int id)
        {
            try
            {
                string idKey = EmploymentTypeCacheKeys.ById(id);

                EmploymentTypeViewModel? cacheResult = await _cacheService.GetAsync<EmploymentTypeViewModel>(idKey);
                ...
                EmploymentTypeModel result =
                    await _sharedRepository.QuerySingleAsync<EmploymentTypeModel>("[config].[web_get_employment_type_by_id]", parameters)
                    ?? throw new ResponseExceptionFactory(Exceptions.EmploymentTypeNotFound);

                EmploymentTypeViewModel mappedResult = Mapping.Mapper.Map<EmploymentTypeViewModel>(result);
        ...
        public async Task<int> CreateAsync(EmploymentTypeInputModel model)
        {
            try
            {
                ValidateModel(model);
                ...
                List<KeyValuePair<string, object?>> parameters = [
                    new("@p_organization_id", model.OrganizationId),
                    new("@p_name", model.TypeName),
                    new("@p_created_by", _httpContextService.GetUserId()),
                ];

                EmploymentTypeModel result =
                   await _sharedRepository.QuerySingleAsync<EmploymentTypeModel>("[config].[web_insert_employment_type]", parameters)
        ...
        public async Task UpdateAsync(int id, EmploymentTypeInputModel model)
        {
            try
            {
                ValidateModel(model);
                ...
                await _sharedRepository.ExecuteAsync("[config].[web_update_employment_type]", parameters);
        ...
        public async Task DeleteAsync(int id)
        {
            try
            {
                ...
                EmploymentTypeModel result =
                   await _sharedRepository.QuerySingleAsync<EmploymentTypeModel>("[config].[web_delete_employment_type]", parameters)
                    ?? throw new ResponseExceptionFactory(Exceptions.InternalServerError);
        ...
        public async Task ReorderAsync(ReorderInputModel model)
        {
            try
            {
                ...
                await _sharedRepository.ExecuteAsync("[config].[web_reorder_employment_types]", parameters);
