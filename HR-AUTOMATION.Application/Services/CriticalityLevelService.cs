...
{
    /// <summary>
    /// Provides business logic for managing criticality levels.
    /// </summary>
    ...
    public class CriticalityLevelService(
        ILogger<CriticalityLevelService> logger,
        ISharedRepository sharedRepository,
        ICacheService cacheService,
        IConfiguration configuration,
        IHttpContextService httpContextService,
        IHubContext<NotificationHub> notificationHub
    ) : ICriticalityLevelService
    {
        /// <summary>
        /// Used for logging error and information messages.
        /// </summary>
        private readonly ILogger<CriticalityLevelService> _logger = logger;
        ...
        /// <summary>
        /// Defines the default expiration time used for cached criticality level data.
        /// </summary>
        ...
        /// <summary>
        /// Defines the long expiration time used for cached criticality level data.
        /// </summary>
        ...
        /// </summary>
        private void ValidateModel(CriticalityLevelInputModel model)
        {
            ...
            ValidationResult validationResult = new CriticalityLevelValidator().Validate(model);
        ...
        /// <summary>
        /// Updates the cache version and notifies the appropriate SignalR groups that criticality levels have changed.
        /// </summary>
        ...
        private async Task HandleChangedAsync(int? organizationId = null, int? id = null)
        {
            if (id.HasValue)
            {
                string idKey = CriticalityLevelCacheKeys.ById(id.Value);
            ...
            if (organizationId.HasValue)
            {
                ...
                await _cacheService.SetAsync(CriticalityLevelCacheKeys.Version(organizationId.Value), CacheKeyHelper.GenerateVersion());
            }

            await _cacheService.SetAsync(CriticalityLevelCacheKeys.Version(), CacheKeyHelper.GenerateVersion());
            await _notificationHub.Clients.Groups(notifyTo).SendAsync(HubKeys.CriticalityLevelChanged);
        }
        ...
        public async Task<IEnumerable<CriticalityLevelViewModel>> SearchAsync(CriticalityLevelSearchInputModel model)
        {
            try
            {
                int? organizationId = _httpContextService.GetOrganizationId();
                ...
                string versionKey = CriticalityLevelCacheKeys.Version(model.OrganizationId);
                ...
                string searchKey = CriticalityLevelCacheKeys.Search(model, version);
                IEnumerable<CriticalityLevelViewModel>? cacheResult = await _cacheService.GetAsync<IEnumerable<CriticalityLevelViewModel>>(searchKey);
                ...
                IEnumerable<CriticalityLevelModel> result = await _sharedRepository.QueryAsync<CriticalityLevelModel>("[config].[web_get_criticality_levels]", parameters);

                IEnumerable<CriticalityLevelViewModel> mappedResult = Mapping.Mapper.Map<IEnumerable<CriticalityLevelViewModel>>(result);
        ...
        public async Task<CriticalityLevelViewModel> GetAsync(int id)
        {
            try
            {
                string idKey = CriticalityLevelCacheKeys.ById(id);

                CriticalityLevelViewModel? cacheResult = await _cacheService.GetAsync<CriticalityLevelViewModel>(idKey);
                ...
                CriticalityLevelModel result =
                    await _sharedRepository.QuerySingleAsync<CriticalityLevelModel>("[config].[web_get_criticality_level_by_id]", parameters)
                    ?? throw new ResponseExceptionFactory(Exceptions.CriticalityLevelNotFound);

                CriticalityLevelViewModel mappedResult = Mapping.Mapper.Map<CriticalityLevelViewModel>(result);
        ...
        public async Task<int> CreateAsync(CriticalityLevelInputModel model)
        {
            try
            {
                ValidateModel(model);
                ...
                CriticalityLevelModel result =
                   await _sharedRepository.QuerySingleAsync<CriticalityLevelModel>("[config].[web_insert_criticality_level]", parameters)
        ...
        public async Task UpdateAsync(int id, CriticalityLevelInputModel model)
        {
            try
            {
                ValidateModel(model);
                ...
                await _sharedRepository.ExecuteAsync("[config].[web_update_criticality_level]", parameters);
        ...
        public async Task DeleteAsync(int id)
        {
            try
            {
                ...
                CriticalityLevelModel result =
                   await _sharedRepository.QuerySingleAsync<CriticalityLevelModel>("[config].[web_delete_criticality_level]", parameters)
                    ?? throw new ResponseExceptionFactory(Exceptions.InternalServerError);
        ...
        public async Task ReorderAsync(ReorderInputModel model)
        {
            try
            {
                ...
                await _sharedRepository.ExecuteAsync("[config].[web_reorder_criticality_levels]", parameters);
