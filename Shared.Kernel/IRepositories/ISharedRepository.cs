namespace Shared.Kernel.IRepositories
{
    ...
    public interface ISharedRepository
    {
        ...
        Task<IEnumerable<T>> QueryAsync<T>(string spName, List<KeyValuePair<string, object?>>? parameters = null, CancellationToken cancellationToken = default) where T : new();
        ...
        Task<T?> QuerySingleAsync<T>(string spName, List<KeyValuePair<string, object?>>? parameters = null, CancellationToken cancellationToken = default) where T : new();
        ...
        Task<object?> QueryScalarAsync(string spName, List<KeyValuePair<string, object?>>? parameters = null, CancellationToken cancellationToken = default);
